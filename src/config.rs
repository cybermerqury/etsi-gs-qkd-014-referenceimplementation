...
static ENV_TLS_PRIVATE_KEY: &str = "ETSI_014_REF_IMPL_PRIVATE_KEY";
static ENV_TLS_CERT: &str = "ETSI_014_REF_IMPL_TSL_CERT";
static ENV_NUM_WORKER_THREADS: &str = "ETSI_014_REF_IMPL_NUM_WORKERS";
